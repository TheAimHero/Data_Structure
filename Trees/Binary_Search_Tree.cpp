...
public:
    ...
    void insert(node *f, node *temp, int value);
...
void Binary_Search_Tree::insert(node *f, node *temp, int value)
{
    if (temp == NULL)
    {
        ...
        {
            f->right_child = new_node;
        }
        else
        {
            f->left_child = new_node;
        }
    }
    else if (temp->data == value)
    {
    ...
    {
        f = temp;
        insert(f, temp->left_child, value);
    }
    else
    {
        f = temp;
        insert(f, temp->right_child, value);
    }
}
